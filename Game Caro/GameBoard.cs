...
namespace Game_Caro
{
    class GameBoard
    {
        ...
        public GameBoard(Panel board, TextBox PlayerName, PictureBox Avatar)
        {
            ...
            {
                new Player(fHome.text1, Image.FromFile(Application.StartupPath + "\\images\\player1.jpg"),
                                        Image.FromFile(Application.StartupPath + "\\images\\X.png")),

                new Player(fHome.text2, Image.FromFile(Application.StartupPath + "\\images\\player2.jpg"),
        ...
        #region Duyệt nguyên stack undo cho mỗi lần nhấn
        private bool CheckHorizontal(int CurrRow, int CurrCol, Image PlayerSymbol)
        {
            ...
            if (MatrixPositions[CurrRow][CurrCol - 1].BackgroundImage == null || MatrixPositions[CurrRow][CurrCol + Count].BackgroundImage == null)
            {
                ...
                MessageBox.Show($"Chúc mừng {PlayerName.Text} là người thắng", "Chúc mừng", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return true;
            }
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            if (btn.BackgroundImage != null)
                return; // Nếu ô đã được đánh thì ko cho đánh lại
